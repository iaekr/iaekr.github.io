...
#See if you can turn this presentation into a graph of sorts
```
...
brand_colors <- c(
  "Asus" = "#d3fad6", "HP" = "#d1efb5", "Apple" = "#edeba0", "Dell" = "#c3c48d", "Lenovo" = "#928c6f", "Toshiba" = "#a0d1e3", "MSI" = "#e1a0d1", "Acer" = "#d1a0e3", "Samsung" = "#f0c2ff", "Sony" = "#f7a6c2", "Huawei" = "#ffacac", "Google" = "#ffc6ac","Razer" = "#ffd9ac", "Microsoft" = "#ffe6ac", "Xiaomi" = "#fff4ac", "Fujitsu" = "#e5ffac","Mediacom" = "#acf2ff", "LG" = "#acddff", "Chuwi" = "#acaaff"
)
...
ggplot(brand_nos, aes(x = reorder(Company, n), y = n)) +
...
ggplot(brand_nos, aes(x = fct_reorder(Company, n), y = n)) +
  labs(x = "Company", y = "Number of Laptops", title = "Number of Laptops Produced by Each Company") +
  geom_bar(stat = "identity", fill = "skyblue") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        plot.margin = margin(1, 1, 1, 1, "cm")) 
...
ggplot(brand_quantity, aes(x = Price, y = reorder(Company, Price))) +
